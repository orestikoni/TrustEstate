  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-6 lg:p-8">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Submit Final Verdict</h2>
        <p className="text-gray-600 mb-6">{propertyTitle}</p>

        <div className="mb-8 p-4 sm:p-6 bg-blue-50 border border-blue-200 rounded-xl">
        ...
        <div className="space-y-4 mb-8">
          ...
          <button
            ...
            disabled={submitting}
            className="w-full p-4 sm:p-6 bg-green-50 border-2 border-green-200 rounded-xl hover:bg-green-100 hover:border-green-300 hover:shadow-md transition-all text-left disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            disabled={submitting}
            className="w-full p-4 sm:p-6 bg-yellow-50 border-2 border-yellow-200 rounded-xl hover:bg-yellow-100 hover:border-yellow-300 hover:shadow-md transition-all text-left disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <div className="flex items-center gap-4">
          ...
          <button
            ...
            disabled={submitting}
            className="w-full p-4 sm:p-6 bg-red-50 border-2 border-red-200 rounded-xl hover:bg-red-100 hover:border-red-300 hover:shadow-md transition-all text-left disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <div className="flex items-center gap-4">
